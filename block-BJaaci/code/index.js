...
for (let movie of movies) console.log(movie.actors.length);
// 26. Log the number of genres in all three movies one by one
for (let movie of movies) console.log(movie.genres.length);
// 27. Log the name of all the movies with more than 1 genre
for (let movie of movies) {
  if (movie.genres.length > 1) console.log(movie.title);
}
// 28. Log the name of all the movies with more than 1 actors
for (let movie of movies) {
  if (movie.actors.length > 1) console.log(movie.title);
}
// 29. Log the name of all the movies with exactly 3 actors
for (let movie of movies) {
  if (movie.actors.length == 3) console.log(movie.title);
}
// 30. Log the name of all the movies with year `2018`
for (let movie of movies) {
  if (movie.year == 2018) console.log(movie.title);
}